package com.softSquared.mangoplate.src.home.search_restaurant.localSearchTab_layout.seoul_north;
...
import com.softSquared.mangoplate.src.home.search_restaurant.localSearchTab_layout.seoul_north.interfaces.SeoulNorthRetrofitInterface;
...
public class SeoulNorth extends Fragment {
    ...
    public SeoulNorth(LocalSearchTabLayout localSearchTabLayout) {
    ...
    private void fetchDistricts(int districts) {
        ...
        SeoulNorthRetrofitInterface searchTapRetrofitInterface = retrofit.create(SeoulNorthRetrofitInterface.class);
